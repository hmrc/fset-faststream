  ...
  object Random {
    ...
    */
    ...
    def schemeTypes = randList(List(
        Scheme("Commercial", "CFS", "Commercial", requiresSift = true, requiresForm = true, requiresNumericTest = true),
        Scheme("DigitalAndTechnology", "DaT", "Digital And Technology", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("DiplomaticService", "DS", "Diplomatic Service", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("DiplomaticServiceEconomics", "DSE", "Diplomatic Service Economics", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("DiplomaticServiceEuropean", "EFSDS", "Diplomatic Service European", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("European", "EFS", "European", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("Finance", "FIFS", "Finance", requiresSift = true, requiresForm = true, requiresNumericTest = true),
        Scheme("Generalist", "GFS", "Generalist", requiresSift = false, requiresForm = false, requiresNumericTest = false),
        Scheme("GovernmentCommunicationService", "GCFS", "Government Communication Service", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("GovernmentEconomicsService", "GES", "Government Economics Service", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("GovernmentOperationalResearchService", "GORS", "Government Operational Research Service", requiresSift = true,
          requiresForm = true, requiresNumericTest = false),
        Scheme("GovernmentSocialResearchService", "GSR", "Government Social Research Service", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("GovernmentStatisticalService", "GSS", "Government Statistical Service", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("HousesOfParliament", "HoP", "Houses Of Parliament", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("HumanResources", "HRFS", "Human Resources", requiresSift = false, requiresForm = false, requiresNumericTest = false),
        Scheme("ProjectDelivery", "PDFS", "Project Delivery", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("ScienceAndEngineering", "SEFS", "Science And Engineering", requiresSift = true, requiresForm = true,
          requiresNumericTest = false),
        Scheme("Edip", "EDIP", "Early Diversity Internship Programme", requiresSift = true, requiresForm = true, requiresNumericTest = false),
        Scheme("Sdip", "SDIP", "Summer Diversity Internship Programme", requiresSift = true, requiresForm = true, requiresNumericTest = false)
    ), randNumberOfSchemes())
