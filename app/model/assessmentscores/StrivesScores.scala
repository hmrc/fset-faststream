...
case class StrivesScores(
                          ...
                          b16commitment: Option[Double] = None // exercise 3
                        ) {
...
object StrivesScores {
  ...
  def exercise3Headers: List[String] = List(s"$prefix-b15motivation", s"$prefix-b16commitment")
