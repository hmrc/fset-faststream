...
object ApplicationStatusOrder {
  ...
  def statusMaps(progress: ProgressResponse) = Seq(
    ...
    (progress.phase1TestsInvited, 100, Phase1TestsInvited),
    (progress.phase1TestsStarted, 110, Phase1TestsStarted),
    (progress.phase1TestsCompleted, 120, Phase1TestsCompleted),
    (progress.phase1TestsExpired, 130, Phase1TestsExpired),
    (progress.phase1TestsResultsReceived, 140, Phase1TestsResultsReceived),
