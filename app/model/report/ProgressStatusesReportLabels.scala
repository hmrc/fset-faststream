...
trait ProgressStatusesReportLabels {
  ...
  private def statusMaps(progress: ProgressResponse) = Seq(
    ...
    (progress.siftProgressResponse.failedAtSift, 405, SiftFailed),
    (progress.siftProgressResponse.failedAtSiftNotified, 406, SiftFailedNotified),
    (progress.siftProgressResponse.sdipFailedAtSift, 407, SdipSiftFailed),
