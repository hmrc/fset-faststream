...
trait ProgressStatusesReportLabels {
  ...
  private def statusMaps(progress: ProgressResponse) = Seq(
    ...
    (progress.phase1ProgressResponse.phase1TestsExpired, 130, Phase1TestsExpired),
    (progress.phase1ProgressResponse.phase1TestsStarted, 140, Phase1TestsStarted),
    (progress.phase1ProgressResponse.phase1TestsCompleted, 150, Phase1TestsCompleted),
    ...
    (progress.phase2ProgressResponse.phase2TestsExpired, 230, Phase2TestsExpired),
    (progress.phase2ProgressResponse.phase2TestsStarted, 240, Phase2TestsStarted),
    (progress.phase2ProgressResponse.phase2TestsCompleted, 250, Phase2TestsCompleted),
    ...
    (progress.phase3ProgressResponse.phase3TestsExpired, 330, Phase3TestsExpired),
    (progress.phase3ProgressResponse.phase3TestsStarted, 340, Phase3TestsStarted),
    (progress.phase3ProgressResponse.phase3TestsCompleted, 350, Phase3TestsCompleted),
