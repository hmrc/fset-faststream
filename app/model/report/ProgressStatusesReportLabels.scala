...
trait ProgressStatusesReportLabels {
  ...
  private def statusMaps(progress: ProgressResponse) = Seq(
    ...
    (progress.siftProgressResponse.siftFormsSubmitted, 397, SiftFormsSubmitted),
    (progress.siftProgressResponse.allSchemesSiftCompleted, 398, SiftCompleted),
...
object ProgressStatusesReportLabels extends ProgressStatusesReportLabels {
  ...
  val SiftEntered = "all_schemes_sift_entered"
  val SiftFormsSubmitted = "all_schemes_sift_forms_submitted"
