...
object AssessmentScheduleCommands {
  ...
  case class CandidateAllocation(candidateName: String, onlineTestDate: DateTime, hasAdjustment: Boolean,
    scheduledAt: Option[String], requestConfirmation: Option[Boolean])

  object Implicits {
    implicit val CandidateAllocationFormats: Format[CandidateAllocation] = Json.format[CandidateAllocation]
