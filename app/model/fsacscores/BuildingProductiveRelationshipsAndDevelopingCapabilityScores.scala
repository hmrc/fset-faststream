...
case class BuildingProductiveRelationshipsAndDevelopingCapabilityScores(
...
object BuildingProductiveRelationshipsAndDevelopingCapabilityScores {
  implicit val buildingProductiveRelationshipsAndDevelopingCapabilityScoresFormat =
    Json.format[BuildingProductiveRelationshipsAndDevelopingCapabilityScores]
}
