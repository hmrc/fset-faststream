...
object ApplicationStatus extends Enumeration with ApplicationStatusOnlyForTest {
  ...
  val ASSESSMENT_CENTRE_AWAITING_ALLOCATION, ASSESSMENT_CENTRE_ALLOCATION_UNCONFIRMED, ASSESSMENT_CENTRE_ALLOCATION_CONFIRMED = Value
  val ASSESSMENT_CENTRE_FAILED_TO_ATTEND, ASSESSMENT_CENTRE_SCORES_ENTERED, ASSESSMENT_CENTRE_SCORES_ACCEPTED = Value
  val ASSESSMENT_CENTRE_AWAITING_RE_EVALUATION = Value
  val ASSESSMENT_CENTRE_PASSED, ASSESSMENT_CENTRE_PASSED_NOTIFIED, ASSESSMENT_CENTRE_FAILED, ASSESSMENT_CENTRE_FAILED_NOTIFIED = Value
