...
case class CreateAdminUserStatusData(email: String, firstName: String, lastName: String,
...
object CreateAdminUserStatusData {
  def apply(createRequest: CreateAdminUserStatusRequest)(generatorId: Int): CreateAdminUserStatusData = {
    ...
    CreateAdminUserStatusData(s"$username@mailinator.com", firstName, lastName, preferredName, role, phone, assessorData)
  }
