...
object SkillType extends Enumeration {
  ...
  val FCO_ASSESSOR, GCFS_ASSESSOR, EAC_ASSESSOR, EAC_DS_ASSESSOR, GES_DS_ASSESSOR, SAC_ASSESSOR, HOP_ASSESSOR = Value
  val PDFS_ASSESSOR, PRO_ASSESSOR, SEFS_ASSESSOR, EDIP_ASSESSOR, SDIP_ASSESSOR, SDIP_QAC, EDIP_QAC = Value
  val SAC_SAM_ASSESSOR, SAC_EM_ASSESSOR, ORAC_QAC, ORAC_EM_ASSESSOR, OPD_ASSESSOR, OPD_STEM_ASSESSOR = Value
