...
object DataStoreEvent {
  ...
  implicit def toDataStoreEvent(dataStoreEvent: DataStoreEvent): model.persisted.AuditEvent =
    AuditEvent(dataStoreEvent.eventName, dataStoreEvent.eventCreated, dataStoreEvent.applicationId, dataStoreEvent.userId, dataStoreEvent.createdBy)
}
