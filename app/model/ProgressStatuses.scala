...
object ProgressStatuses {
  ...
  {
    val relativeOrder = List(CREATED, PERSONAL_DETAILS, PARTNER_GRADUATE_PROGRAMMES, SCHEME_PREFERENCES, ASSISTANCE_DETAILS,
      PREVIEW, SUBMITTED, FAST_PASS_ACCEPTED, PHASE1_TESTS_INVITED, PHASE1_TESTS_STARTED, PHASE1_TESTS_COMPLETED, PHASE1_TESTS_RESULTS_READY,
      PHASE1_TESTS_RESULTS_RECEIVED, PHASE1_TESTS_PASSED, PHASE1_TESTS_PASSED_NOTIFIED,
      PHASE2_TESTS_INVITED, PHASE2_TESTS_STARTED, PHASE2_TESTS_COMPLETED,
      PHASE2_TESTS_RESULTS_RECEIVED, PHASE2_TESTS_PASSED, PHASE3_TESTS_INVITED, PHASE3_TESTS_STARTED, PHASE3_TESTS_COMPLETED,
      PHASE3_TESTS_RESULTS_RECEIVED, PHASE3_TESTS_PASSED, PHASE3_TESTS_PASSED_NOTIFIED, SIFT_ENTERED,
      SIFT_FORMS_COMPLETE_NUMERIC_TEST_PENDING, SIFT_TEST_INVITED, SIFT_TEST_STARTED, SIFT_TEST_COMPLETED, SIFT_TEST_RESULTS_RECEIVED,
      SIFT_READY, SIFT_COMPLETED, ASSESSMENT_CENTRE_AWAITING_ALLOCATION, ASSESSMENT_CENTRE_ALLOCATION_UNCONFIRMED,
      ASSESSMENT_CENTRE_ALLOCATION_CONFIRMED, ASSESSMENT_CENTRE_SCORES_ENTERED, ASSESSMENT_CENTRE_SCORES_ACCEPTED,
      ASSESSMENT_CENTRE_PASSED, FSB_AWAITING_ALLOCATION, FSB_ALLOCATION_CONFIRMED, FSB_RESULT_ENTERED, FSB_PASSED, ELIGIBLE_FOR_JOB_OFFER
    )
