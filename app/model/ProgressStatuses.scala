...
object ProgressStatuses {
  ...
  case object ALL_FSBS_FAILED extends ProgressStatus(ApplicationStatus.FSB)
  case object ALL_FSBS_FAILED_NOTIFIED extends ProgressStatus(ApplicationStatus.FSB)
