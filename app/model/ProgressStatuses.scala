...
object ProgressStatuses {
  ...
  case object PHASE1_TESTS_FAILED_SDIP_NOT_FAILED extends ProgressStatus(ApplicationStatus.PHASE1_TESTS)
  ...
  case object PHASE2_TESTS_FAILED_SDIP_NOT_FAILED extends ProgressStatus(ApplicationStatus.PHASE2_TESTS)
  ...
  case object PHASE3_TESTS_FAILED_SDIP_NOT_FAILED extends ProgressStatus(ApplicationStatus.PHASE3_TESTS)
