...
object Occupations {
  val seq = Seq(
    ...
    ("Clerical and intermediate", "Secretary, personal assistant, clerical worker, office clerk, call centre agent, nursing auxiliary, nursery nurse"),
    ("Senior managers and administrators", "Usually responsible for planning, organising and co-ordinating work and financial responsibilities, such as: finance manager, chief executive"),
