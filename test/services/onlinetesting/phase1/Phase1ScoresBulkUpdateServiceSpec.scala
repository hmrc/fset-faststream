...
class Phase1ScoresBulkUpdateServiceSpec extends BaseServiceSpec {
  ...
  trait TestFixture {
    ...
    val service = new Phase1ScoresBulkUpdateService(mockApplicationRepository, mockPhase1TestRepository)
  }
}
