...
class OnlineTestResultsCalculator2Spec extends UnitSpec {

  "evaluate test result" should {
    "give green result" in new OnlineTestResultsCalculator2 {
    ...
    "give amber result" in new OnlineTestResultsCalculator2 {
    ...
    "give red result" in new OnlineTestResultsCalculator2 {
