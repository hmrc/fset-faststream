...
class DashboardPageSpec extends PlaySpec with TableDrivenPropertyChecks {
  ...
  val Applications = Table(
    ...
    (PHASE1_TESTS_FAILED,                      ProgressActive,   ProgressInactive, ProgressInactive,          ProgressInactive,         true,                                    false,                                    false,                    false,                              false,                      true,                 false,                 false,                         true,                  "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN)
