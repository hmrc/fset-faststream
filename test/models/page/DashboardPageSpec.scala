...
class DashboardPageSpec extends PlaySpec with TableDrivenPropertyChecks {
  ...
  val Applications = Table(
    ("applicationStatus",                      "step1",          "step2",         "step3",                    "step4",                  "isApplicationSubmittedAndNotWithdrawn", "isApplicationInProgressAndNotWithdrawn", "isApplicationWithdrawn", "isApplicationCreatedOrInProgress", "isUserWithNoApplication",  "isPhase1TestsPassed", "isTestGroupExpired", "isPhase2TestGroupExpired",    "isPhase1TestFailed",  "fullName",   "testProfile", "testProfile",  "assessmentInProgressStatus",       "assessmentCompletedStatus"),
    (REGISTERED,                               ProgressInactive, ProgressInactive, ProgressInactive,          ProgressInactive,         false,                                   false,                                    false,                    false,                              true,                       false,                 false,                 false,                        false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (CREATED,                                  ProgressActive,   ProgressInactive, ProgressInactive,          ProgressInactive,         false,                                   true,                                     false,                    true,                               false,                      true,                 false,                 false,                         false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (IN_PROGRESS,                              ProgressActive,   ProgressInactive, ProgressInactive,          ProgressInactive,         false,                                   true,                                     false,                    true,                               false,                      true,                 false,                 false,                         false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (SUBMITTED,                                ProgressActive,   ProgressInactive, ProgressInactive,          ProgressInactive,         true,                                    false,                                    false,                    false,                              false,                      true,                 false,                 false,                         false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (WITHDRAWN,                                ProgressActive,   ProgressActive,   ProgressActive,            ProgressInactiveDisabled, false,                                   false,                                    true,                     false,                              false,                      true,                 false,                 false,                         false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (PHASE1_TESTS,                             ProgressActive,   ProgressActive,   ProgressInactiveDisabled,  ProgressInactiveDisabled,  true,                                   false,                                    false,                    false,                              false,                      true,                 true,                  false,                         false,                 "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN),
    (PHASE1_TESTS_FAILED,                      ProgressActive,   ProgressInactive, ProgressInactiveDisabled,  ProgressInactiveDisabled,  true,                                    false,                                    false,                    false,                              false,                      true,                 false,                 false,                         true,                  "John Biggs",  None,         None,           ASSESSMENT_STATUS_UNKNOWN,          POSTASSESSMENT_STATUS_UNKNOWN)
  ...
  "The Steps visibility" should {
    ...
    "be tested for all statuses" ignore {
      val statusesTested = Applications.toList.map { case (status, _, _, _, _ , _, _, _, _, _, _, _, _, _, _, _, _, _, _) => status }
  ...
  val WithdrawnApplications = Table(
    ("Status before Withdraw", "step1", "step2", "step3", "step4", "isApplicationSubmittedAndNotWithdrawn", "isApplicationInProgressAndNotWithdrawn", "isApplicationWithdrawn", "isApplicationCreatedOrInProgress", "isUserWithNoApplication", "isPhase1TestsPassed", "isTestGroupExpired", "isPhase2TestGroupExpired", "isPhase1TestFailed", "fullName", "testProfile", "phase2TestProfile", "assessmentInProgressStatus", "assessmentCompletedStatus"),
    (PersonalDetailsProgress, ProgressActive, ProgressInactiveDisabled, ProgressInactiveDisabled, ProgressInactiveDisabled, false, false, true, false, false, false, false, false, false, "John Biggs", None, None, ASSESSMENT_STATUS_UNKNOWN, POSTASSESSMENT_STATUS_UNKNOWN),
    (SubmittedProgress, ProgressActive, ProgressInactiveDisabled, ProgressInactiveDisabled, ProgressInactiveDisabled, false, false, true, false, false, false, false, false, false, "John Biggs", None, None, ASSESSMENT_STATUS_UNKNOWN, POSTASSESSMENT_STATUS_UNKNOWN)
  )
  // scalastyle:on line.size.limit
  // format: on
