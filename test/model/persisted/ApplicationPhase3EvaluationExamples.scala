...
object ApplicationPhase3EvaluationExamples {
  def faststreamPsiApplication(implicit now: Instant) = ApplicationReadyForEvaluation("app1", ApplicationStatus.PHASE3_TESTS,
  ...
  def sdipFaststreamPsiApplication(implicit now: Instant) = ApplicationReadyForEvaluation("app1", ApplicationStatus.PHASE3_TESTS,
